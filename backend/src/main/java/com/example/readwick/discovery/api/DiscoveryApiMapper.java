package com.example.readwick.discovery.api;

import com.example.readwick.discovery.api.dto.DiscoveryResponse;
import com.example.readwick.discovery.api.dto.RecommendedBookDto;
import com.example.readwick.discovery.api.dto.SearchResultDto;
import com.example.readwick.discovery.application.AuthorRecommendations;
import com.example.readwick.discovery.application.CategoryRecommendations;
import com.example.readwick.discovery.application.DiscoveryData;
import com.example.readwick.discovery.application.SearchRecommendations;
