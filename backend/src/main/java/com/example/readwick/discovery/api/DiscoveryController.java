...
import com.example.readwick.discovery.application.DiscoveryService;
import com.example.readwick.discovery.application.SearchHistoryService;
...
public class DiscoveryController {
    ...
    public ResponseEntity<Void> logSearch(@jakarta.validation.Valid @RequestBody com.example.readwick.discovery.api.dto.LogSearchRequest request, @CurrentUser User user) {
