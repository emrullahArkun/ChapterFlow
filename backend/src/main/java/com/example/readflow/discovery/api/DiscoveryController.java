...
public class DiscoveryController {
    ...
    public ResponseEntity<Void> logSearch(@jakarta.validation.Valid @RequestBody com.example.readflow.discovery.api.dto.LogSearchRequest request, @CurrentUser User user) {
